      ...
      <form action="{{route('store.project')}}" method="post" enctype="multipart/form-data">
        ...
        <label class="block mt-4 text-sm">
          ...
          <textarea
            ...
            rows="3" name="client_description" placeholder="Enter some descriptions about client"></textarea>
        </label>
        </div>
        ...
        <label class="block mt-4 text-sm">
          ...
          <textarea
            class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-gray-100 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
            rows="3" placeholder="Enter the project descriptions" name="project_description"></textarea>
        </label>
        </div>
