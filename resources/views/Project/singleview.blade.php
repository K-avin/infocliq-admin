...
<div class="container px-6 mx-auto grid">
    ...
    @if (Request::segment(4) == $module->projectId)
    <div class="grid gap-6 mb-4  xl:grid-cols-1">  
        <div class="items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
            <div class="m-1">
                <p class="mb-2 text-md font-medium text-gray-500 dark:text-gray-300">Module : {{$module->moduleName}}</p>         
            </div>
        </div>
    </div>
    <div class="grid gap-6 mb-8  xl:grid-cols-1">  
                ...
                <div class="w-full overflow-x-auto">
                  <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                      ...
                      @if ($module->id == $task->module && Request::segment(4) == $task->project_id)
