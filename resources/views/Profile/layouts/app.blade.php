  ...
  <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen }">
    <div class="flex flex-col flex-1 w-full">
        <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
            <div
              class="container flex items-center justify-between h-full px-6 mx-auto text-red-500 dark:text-red-300"
            >
              <!-- Mobile hamburger -->
              <button
              ...
              <ul class="flex items-center flex-shrink-0 space-x-6">
                <!-- Home icon -->
                <li class="flex">
                  <a href="{{ route('home.manager') }}" class="rounded-md focus:outline-none focus:shadow-outline-red">
                ...
                <li class="relative">
                  ...
                  >
                    ...
                    <span
                      aria-hidden="true"
                      class="animate-bounce absolute top-0 right-0 inline-block w-3 h-3 transform translate-x-1 -translate-y-1 bg-red-600 border-2 border-white rounded-full dark:border-gray-800"
                    ></span>
                  </button>
                ...
                <li class="relative">
                  ...
                  >
                    <img
                      ...
                      src="https://avatars.githubusercontent.com/u/19858893?v=4"
                      alt=""
                      aria-hidden="true"
                    />
                  </button>
